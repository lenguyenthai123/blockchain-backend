...
function generateMnemonic() {
  ...
  // Use crypto-secure random to select 12 words
  for (let i = 0; i < 12; i++) {
...
// Convert mnemonic to key pair using secp256k1

function mnemonicToKeyPair(mnemonic) {
  // Validate mnemonic has exactly 12 words
  ...
  const seed = crypto.createHash("sha256").update(mnemonic.toLowerCase()).digest()
  let privateKey = seed
  // Ensure privateKey is valid for secp256k1
